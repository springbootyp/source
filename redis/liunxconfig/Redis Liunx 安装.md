...
- 准备linux环境；
- 官网<https://redis.io/> 下载redis4.0.6版本；
- 上传至linux；
...
```
[root@localhost bin]# ./redis-server -f /usr/redis.conf 自己配置的文件
```

使用内置的客户端命令redis-cli进行使用：

```
[root@localhost bin]# ./redis-cli -h -p
